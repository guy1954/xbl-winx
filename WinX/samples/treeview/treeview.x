...
FUNCTION initWindow ()
	...
	#hMain = WinXNewWindow (0, "Tree View demo " + WinXVersion$ (), -1, -1, 400, 300, $$XWSS_APP, 0, 0, 0)
	...
	WinXAutoSizer_SetSimpleInfo (hTV, -1, 0.00, 1.00, 0)
...
'	h# = 0.98			' height (98%)
'	flags = 0
'	WinXAutoSizer_SetInfo (hTV, main_series, space#, size#, x#, y#, w#, h#, flags)
